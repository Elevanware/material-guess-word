        ...
        <form onSubmit={form.handleSubmit(handleSubmit)} className="p-6 space-y-6">
          ...
          <div>
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                ...
                className="px-8 py-3 text-sm bg-black text-white hover:bg-gray-800 px-4 py-2 rounded-full font-medium transition"
              >
              Add Word
              </button>
            </div>
          ...
          <div className="flex justify-end space-x-3 pt-10 border-t border-gray-200">
            <button
              type="button"
              onClick={handleCancel}
              className="px-10 py-3 border border-gray-300 text-gray-700 rounded-full hover:bg-gray-100 font-semibold transition"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="px-8 py-3 bg-black text-white rounded-full font-semibold transition hover:bg-gray-800"
            >
              Save Game
            </button>
          </div>
